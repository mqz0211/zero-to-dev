...
![License](https://img.shields.io/github/license/YOUR_USERNAME/Student-Tech-Roadmap)
...
Most tech roadmaps assume you already know what a terminal is, what GitHub
does, or what "the cloud" actually means. That assumption quietly filters
out the exact people who need a roadmap the most — people just starting
out. **Student Tech Roadmap explains the things other roadmaps skip**,
then gets out of your way and shows you exactly what to learn, build, and
read, in order, for free.

This is v1: a complete, navigable, markdown-based knowledge base. A v2
...
Student-Tech-Roadmap/
│
├── ROADMAPS/          # 7 career paths, each: fundamentals → professional
├── FUNDAMENTALS/       # What is RAM? What is GitHub? What is an API? — start here
├── PROJECTS/           # Project ideas, sequenced by difficulty, not random
├── RESOURCES/          # Curated free courses, books, YouTube channels, sites
├── CAREERS/            # Internships, portfolio-building, GitHub profile guide
...
Intermediate skills
   ↓
Build intermediate/advanced projects
   ↓
...
Projects are **sequenced**, not just listed — e.g. the Software Engineer
path's Python track goes `Calculator → Password Manager → Web Scraper →
AI Assistant`, each one deliberately harder than the last and reusing
...
- [ ] v2 — Interactive GitHub Pages site: click-to-explore path selector, progress tracking, search
- [ ] v2.1 — Translated versions (starting with Bahasa Malaysia)

## License

Content in this repository is licensed under
[CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) — use it,
translate it, remix it, just credit the project.
