...
> These are internship/junior-role-portfolio-grade. Each one is scoped
...
- **Build your own HTTP server from raw sockets** — no framework;
  understand what Flask/Express are actually doing for you.
...
- **Build and document a full home-lab penetration test** — set up
  ...
  professional-style pentest report.
- **Build a SIEM-lite log correlation tool** — ingest logs from
  multiple sources, correlate events, flag likely incidents.
...
- **Build a Retrieval-Augmented Generation (RAG) system** — combine a
  ...
  documents.
- **Train a model from scratch on a real dataset** — not fine-tuning;
  actual architecture design, training loop, evaluation.
...
- **Build Infrastructure-as-Code for a real project** — Terraform or
  similar, so your infrastructure is versioned and reproducible.

## What makes a project "advanced portfolio-grade"

- It solves a **real** problem, not a toy version of one
- It has **tests** and a **CI pipeline**
- It's **deployed** somewhere a stranger can actually try it
- It has a **README** good enough that a recruiter understands it in 60 seconds
- You can **explain the hard trade-off decisions** you made, not just that it works

## Next steps

- [Portfolio guide](../CAREERS/portfolio.md) — how to present these on GitHub and your resume
- [Internships guide](../CAREERS/internships.md) — how to actually use this portfolio to get in the door
